...
<body>
	...
	NumberFormat currentLocale = NumberFormat.getInstance();
		...
		ArrayList<Product> List_AllProduct_Sale = prdao.PagingProduct_Sale(index);
		...
		ArrayList<Product> List_ProductByCategory_Sale = prdao.PagingProduct_ByCategory_Sale(id_category, index1);
		...
		ArrayList<Product> List_ProductByBrand_Sale = prdao.PagingProduct_ByBrand_Sale(id_brand, index2);
		...
		ArrayList<Product> List_ProductBySeason_Sale = prdao.PagingProduct_BySeason_Sale(id_season, index3);
	%>
	...
	<div class="features_items"
				...
				<div class="col-sm-12 tim-kiem">
					<ul class="nav nav-tabs" style="margin-bottom: 5%;">
						...
						<li class="active"
							...
							href="index_sale.jsp" style="background: #696763; color: white"> Sản Phẩm Khuyến Mãi</a></li>
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr : List_AllProduct_Sale) {
				%>
				...
				<div class="col-sm-3 tim-kiem">
					<div class="product-image-wrapper" style="height: 422px">
						<div class="single-products">
							...
							<img src="images/home/sale.png" class="new" alt="" /> <img
								<%if (pr.getQuantity() == 0) {%>
			...
			<div>
				<ul class="pagination tim-kiem">
					<%
						int count = prdao.GetTotalProduct_Sale();
						int endpage = count / 8;
						if (count / 8 != 0)
							endpage++;
					...
					%>
					<li><a class="tim-kiem" href="index_sale.jsp?&index=<%=i%>"
	...
	<div class="col-sm-9 padding-right">
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr1 : List_ProductByCategory_Sale) {
				%>
			...
			<ul class="pagination tim-kiem">
				<%
					int count1 = prdao.GetTotalProduct_ByCategory_Sale(id_category);
				...
				%>
				<li><a class="tim-kiem"
					href="index_sale.jsp?id_category=<%=id_category%>&index1=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr2 : List_ProductByBrand_Sale) {
				%>
			...
			<ul class="pagination tim-kiem">
				<%
					int count2 = prdao.GetTotalProduct_ByBrand_Sale(id_brand);
				...
				%>
				<li><a class="tim-kiem"
					href="index_sale.jsp?id_brand=<%=id_brand%>&index2=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr3 : List_ProductBySeason_Sale) {
				%>
			...
			<ul class="pagination tim-kiem">
				<%
					int count3 = prdao.GetTotalProduct_BySeason_Sale(id_season);
				...
				%>
				<li><a class="tim-kiem"
					href="index_sale.jsp?id_season=<%=id_season%>&index3=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
