	...
	<div class="container-login">
		<div class="login-form" style="width: 36%">
			...
			<form action="EditPassword" method="post">
				...
				<input type="text" placeholder="Nhập mật khẩu" name="password1"
					value=""
					style="padding-left: 0px; margin-bottom: 3%; width: 300px; text-align: center" />
				<p id="userregister-error"
					style="color: black; margin-left: 25%; margin-top: 2%"><%=ePassword1%></p>
					

				<input type="text" placeholder="Nhập lại mật khẩu" name="password2"
					value=""
					style="padding-left: 0px; margin-bottom: 3%; width: 300px; text-align: center" />
				<p id="userregister-error"
					style="color: black; margin-left: 25%; margin-top: 2%"><%=ePassword2%></p>



				<button style="margin: 25px auto; width: 300px" type="submit"
					class="btn btn-default">Tiếp theo</button>
