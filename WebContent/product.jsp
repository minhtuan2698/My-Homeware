...
<body>
	...
	NumberFormat currentLocale = NumberFormat.getInstance();
		...
		ArrayList<Product> List_ProductByCategory = prdao.PagingProduct_ByCategory(id_category, index1);
		...
		ArrayList<Product> List_ProductByBrand = prdao.PagingProduct_ByBrand(id_brand, index2);
		...
		ArrayList<Product> List_ProductBySeason = prdao.PagingProduct_BySeason(id_season, index3);
	%>
	...
	<div class="features_items"
				...
				<div class="col-sm-12 tim-kiem">
					<ul class="nav nav-tabs" style="margin-bottom: 5%;">
						<li class="active"><a href="index.jsp" 
							style="background: #696763; color: white">Tổng Hợp Sản Phẩm </a></li>

						<li class="active"
							style="border-right: 1px solid black; border-left: 1px solid black"><a
							href="index_sale.jsp"> Sản Phẩm Khuyến Mãi</a></li>

						<li class="active"><a href="index_hot.jsp"> Bán Chạy Nhất</a></li>
			...
			<!-- // danh sách sản phẩm -->
			<marquee width="96%" behavior="alternate" 
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr : List_AllProduct) {
				%>
					...
					<div class="product-image-wrapper" style="height: 422px">
						<div class="single-products">
							<div class="productinfo text-center">
								...
								<a
									href="Cart_Controller?action=insert&ID_Product=<%=pr.getId_product()%>&ID_User=<%=id %>"
									<%if (pr.getQuantity() == 0) {%>
							...
							<img src="images/home/new.png" class="new" alt="" /> <img
								<%if (pr.getQuantity() == 0) {%>
			...
			<div>
				<ul class="pagination tim-kiem">
					<%
						int count = prdao.GetTotalProduct();
						int endpage = count / 8;
						if (count / 8 != 0)
							endpage++;
					...
					%>
					<li><a class="tim-kiem" href="index.jsp?&index=<%=i%>"
	...
	<div class="col-sm-9 padding-right">
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr1 : List_ProductByCategory) {
				%>
			...
			<ul class="pagination tim-kiem">
				<%
					int count1 = prdao.GetTotalProduct_ByCategory(id_category);
				...
				%>
				<li><a class="tim-kiem"
					href="index.jsp?id_category=<%=id_category%>&index1=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr2 : List_ProductByBrand) {
				%>
					...
					<div class="product-image-wrapper" style="height: 422px">
						<div class="single-products">
							<div class="productinfo text-center">
								...
								<a
									href="Cart_Controller?action=insert&ID_Product=<%=pr2.getId_product()%>&ID_User=<%=id %>"
			...
			<ul class="pagination tim-kiem">
				<%
					int count2 = prdao.GetTotalProduct_ByBrand(id_brand);
				...
				%>
				<li><a class="tim-kiem"
					href="index.jsp?id_brand=<%=id_brand%>&index2=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
		...
		<div class="features_items"
			...
			<div style="display: flex; flex-wrap: wrap;">
				...
				<%
					for (Product pr3 : List_ProductBySeason) {
				%>
					...
					<div class="product-image-wrapper" style="height: 422px">
						<div class="single-products">
							<div class="productinfo text-center">
								...
								<a
									href="Cart_Controller?action=insert&ID_Product=<%=pr3.getId_product()%>&ID_User=<%=id %>"
			...
			<ul class="pagination tim-kiem">
				<%
					int count3 = prdao.GetTotalProduct_BySeason(id_season);
				...
				%>
				<li><a class="tim-kiem"
					href="index.jsp?id_season=<%=id_season%>&index3=<%=i%>"
					style="border: 1px solid black; color: white; font-weight: bold; background: #696763"><%=i%></a></li>
				<%
					}
				%>
