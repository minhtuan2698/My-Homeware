		...
		<div class="login-form">
			...
			<form action="Login_Controller" method="post">
				...
				<input type="text" placeholder="Tài Khoản" name="username"
					value="<%=userName%>" style="margin-bottom: 3%" /> <input
					type="password" placeholder="Mật Khẩu" name="password"
					value="<%=password%>" style="margin-bottom: 3%" />
				<p style="color: #34fe0f; margin-left: 7%"><%=error%>
					<input type="hidden" name="access" value="2" /> <input
						type="hidden" name="status" value="1" />
				<div class="row margin-bottom-5">
					<div class="col-xs-6 checkbox-margin">
						<span> <input type="checkbox" name="rememberme" value="1"
							<%=x%> class="checkbox" style="font-weight: bold"> Ghi
							nhớ tài khoản
						</span>
					</div>
					<div class="col-xs-6 text-right qmk">
						<a id="forgot-password" href="ForgotPassword.jsp"
							style="font-weight: bold; text-decoration: underline">Quên
							mật khẩu?</a>
					</div>
				</div>
				...
				<div style="padding-left: 15%" class="fb-login-button btn-fb"
					data-width="1000px" data-size="large" data-button-type="login_with"
					data-auto-logout-link="false" data-use-continue-as="false"
					scope="public_profile,email" onlogin="checkLoginState();"></div>

				<div style="margin-bottom: 5%; margin-top: 2%">
					<a id="register-click" href="register.jsp"> Bạn chưa có tài
