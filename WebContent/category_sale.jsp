			...
			<div class="panel-group category-products" id="accordian">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul >
							<li ><a
								href="index_sale.jsp?id_category=<%=cate_child.getId_category()%>&index1=1"><%=cate_child.getName_category()%></a></li>
			...
			<div class="panel-group category-products" id="accordian1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul>
							<li><a
								href="index_sale.jsp?id_brand=<%=brand_child.getId_brand()%>&index2=1"><%=brand_child.getName_brand()%></a></li>
							<%
								}
							%>
						</ul>
			...
			<div class="panel-group category-products" id="accordian1">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul>
							<li><a
								href="index_sale.jsp?id_season=<%=season.getID_Season()%>&index3=1"><%=season.getName_Season()%></a></li>
